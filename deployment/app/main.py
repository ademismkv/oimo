...
# Define model and dataset directories with proper paths
APP_DIR = os.path.dirname(os.path.abspath(__file__))
MODEL_PATH = os.path.join(APP_DIR, "best.pt")
MEANINGS_PATH = os.path.join(APP_DIR, "meanings.csv")
...
# For Railway and other cloud platforms - use the PORT environment variable if set
